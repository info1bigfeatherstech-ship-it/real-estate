...
// ✅ UPDATED — Naye status add kiye
const PROPERTY_STATUSES = Object.freeze([
  'draft',      // Owner/Agent ne save kiya but publish nahi kiya
  'pending',    // Admin approval waiting (NEW)
  'active',     // Admin approved → Public website pe dikhega
  'rejected',   // Admin rejected (NEW)
  'inactive',   // Admin ne deactivate kiya
  'rented',     // Property rented out (NEW)
  'occupied',   // Property occupied (NEW)
  'sold',       // Property sold (NEW)
]);
