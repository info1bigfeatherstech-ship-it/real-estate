...
//     pets: { type: String, enum: ALLOWANCE_POLICY_OPTIONS, default: null },
//     smoking: { type: String, enum: ALLOWANCE_POLICY_OPTIONS, default: null },
//     alcohol: { type: String, enum: ALLOWANCE_POLICY_OPTIONS, default: null },
//     guestPolicy: { type: String, enum: GUEST_POLICY_OPTIONS, default: null },
...
fomoEnabled: {        
  ...
  default: true,      // ✅ Enabled by default
    ...
    // ✅ FIX 1: Dynamic reference for createdBy
    createdBy: {
      type: mongoose.Schema.Types.ObjectId,
      refPath: 'createdByModel',  // ← Dynamic: 'User' ya 'Customer'
      required: true,
      index: true,
    },
    createdByModel: {
    ...
    // ✅ FIX 2: Dynamic reference for lastUpdatedBy
    lastUpdatedBy: {
      type: mongoose.Schema.Types.ObjectId,
      refPath: 'updatedByModel',  // ← Dynamic: 'User' ya 'Customer'
      default: null,
    },
    updatedByModel: {
      type: String,
